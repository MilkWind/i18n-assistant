...
class I18nOptimizer:
    ...
    def optimize(self, analysis_result: AnalysisResult, parse_result: ParseResult) -> OptimizationResult:
        ...
        print(f"[INFO] 优化准备: 找到 {len(unused_keys_by_file)} 个文件有未使用键, {len(missing_keys_by_file)} 个文件需要添加键")
        ...
        for file_info in i18n_files:
            ...
            # 优化当前文件
            optimized_data, removed_count, added_count = self._optimize_file_data(
                original_data, 
                unused_keys_for_file,
        ...
        print(f"[INFO] 优化完成: 总计移除 {optimization_result.removed_keys_count} 个键, 添加 {optimization_result.added_keys_count} 个键")
    ...
    def _generate_optimization_summary(self, analysis_result: AnalysisResult, 
        ...
        return {
            "optimization_stats": {
                "total_removed_keys": optimization_result.removed_keys_count,
            ...
            "files": {
                "optimized": list(optimization_result.optimized_files.values()),
    ...
    def _save_optimization_report(self, optimization_result: OptimizationResult, 
        ...
        detailed_report = {
            ...
            "file_operations": {
                "optimized_files": optimization_result.optimized_files,
                "backup_files": optimization_result.backup_files
            },
            "analysis_details": {
                "missing_keys": [
                    {
                        ...
                        "line_number": mk.line_number,
                        "suggested_files": mk.suggested_files
                    }
                    for mk in analysis_result.missing_keys
                ],
                "unused_keys": [
                    {
                        "key": uk.key,
                        "i18n_file": uk.i18n_file,
                        "value": uk.value
                    }
                    for uk in analysis_result.unused_keys
                ]
            }
        }
